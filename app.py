...
def load_or_create_model():
    """Load model, or create a fallback if loading fails"""
    try:
        ...
        logger.info("Creating fallback ResNet50 model...")
        ...
        logger.warning("⚠ Using fallback ResNet50 model (not trained on fake detector data)")
        return model
